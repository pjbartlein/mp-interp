program demo_ts_epstein_01
! demonstrates Epstein (1991) harmonic pseudo-daily interpolation
...
character(1024)     :: sourcepath, interppath, dataname, infile, outfilemon, outfileday, outfilestat
