...
subroutine mp_interp_harzallah(n_outer, n_inner, nctrl, ym, yfill, x_ctrl, nsubint, &
    ...
    do n = 1, n_outer
        ...
        if (debug_write) write (debug_unit, '(a)') " ym_in(1:n_inner_in)"
        if (debug_write) write (debug_unit, '(16g16.9)') ym_in(1:n_inner_in)
        if (debug_write) write (debug_unit, '(a)') " x_ctrl_in(1:n_inner_in)"
        if (debug_write) write (debug_unit, '(16g16.9)') x_ctrl_in(1:n_inner_in)
        if (debug_write) write (debug_unit, '(a)') " nsubint_in(1:n_inner_in)"
        if (debug_write) write (debug_unit, '(16i16)') nsubint_in(1:n_inner_in)
        ...
        if (any(ym_in(1:n_inner_in) .eq. yfill)) then
            ...
            if (debug_write) write (debug_unit,'(16f10.6)') ym_in(1:n_inner_in)
            if (debug_write) write (debug_unit,'(16f10.6)') ym_int_out(1:n_inner_in)
            if (debug_write) write (debug_unit,'(16f10.6)') ym_in(1:n_inner_in) - ym_int_out(1:n_inner_in)
            if (debug_write) then
